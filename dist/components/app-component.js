App = function () {
  ...
  const trackTransaction = useCallback(async (tx, description) => {
    ...
    try {
      ...
      setPendingTxs(prev => prev.map(t => t.id === txId ? {
        ...t,
        status: 'confirmed',
        receipt
      } : t));
  ...
  }, activeTab === 'identity' && /*#__PURE__*/React.createElement(IdentityTab, {
    contracts: contracts,
    account: account,
    userTokens: userTokens,
  ...
  }), activeTab === 'credentials' && /*#__PURE__*/React.createElement(CredentialsTab, {
    contracts: contracts,
    selectedToken: selectedToken,
    userTokens: userTokens,
    showNotification: showNotification
  }), activeTab === 'access' && /*#__PURE__*/React.createElement(AccessControlTab, {
    contracts: contracts,
    selectedToken: selectedToken,
    userTokens: userTokens,
    showNotification: showNotification
  }), activeTab === 'social' && /*#__PURE__*/React.createElement(SocialTab, {
    contracts: contracts,
    selectedToken: selectedToken,
    userTokens: userTokens,
    account: account,
    showNotification: showNotification
  }), activeTab === 'analytics' && /*#__PURE__*/React.createElement(AnalyticsTab, {
    contracts: contracts,
    selectedToken: selectedToken,
    showNotification: showNotification
