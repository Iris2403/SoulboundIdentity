ProjectsSection = function ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("h3", null, "Projects Portfolio"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '8px',
      alignItems: 'center'
  ...
  }, totalProjects, "/", MAX_PROJECTS, isNearLimit && /*#__PURE__*/React.createElement("span", null, "\u26A0\uFE0F")), /*#__PURE__*/React.createElement(Button, {
  ...
  }, "+ Create Project"))), isNearLimit && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u26A0\uFE0F You have ", totalProjects, "/", MAX_PROJECTS, " projects. ", totalProjects >= MAX_PROJECTS ? 'Limit reached!' : 'Approaching limit!')), loading ? /*#__PURE__*/React.createElement(LoadingSpinner, null) : !projects || projects.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "empty-message"
  }, /*#__PURE__*/React.createElement("p", null, "No projects yet. Start showcasing your work!")) : /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("h4", null, "Project #", project.projectId.toString()), /*#__PURE__*/React.createElement("div", {
      className: "project-status",
      style: {
        color: project.status === 2 ? 'var(--success)' : project.status === 3 ? 'var(--error)' : 'var(--sky)'
      }
    }, "Status: ", projectStatuses[project.status]), /*#__PURE__*/React.createElement("p", null, "Created: ", formatDate(project.createdAt)), project.completedAt > 0 && /*#__PURE__*/React.createElement("p", null, "Completed: ", formatDate(project.completedAt)), collabCount > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: '8px',
        padding: '8px',
    ...
    }, "\uD83D\uDC65 Collaborators: ", collabCount, "/", MAX_COLLABORATORS, isNearCollabLimit && ' ⚠️')), /*#__PURE__*/React.createElement("div", {
      className: "project-actions"
    }, /*#__PURE__*/React.createElement("select", {
      className: "status-select",
      value: project.status,
      onChange: e => handleUpdateStatus(project.projectId, parseInt(e.target.value))
    }, projectStatuses.map((status, idx) => /*#__PURE__*/React.createElement("option", {
      key: idx,
      value: idx
    ...
    className: "section-header"
  }, /*#__PURE__*/React.createElement("h3", null, "Projects I'm Collaborating On"), /*#__PURE__*/React.createElement("span", {
    className: "badge"
  }, collaboratingOn?.length || 0)), loading ? /*#__PURE__*/React.createElement(LoadingSpinner, null) : !collaboratingOn || collaboratingOn.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "empty-message"
  }, /*#__PURE__*/React.createElement("p", null, "You're not collaborating on any projects yet")) : /*#__PURE__*/React.createElement("div", {
    className: "projects-grid"
  }, collaboratingOn.map((project, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    className: "project-card",
    style: {
  ...
  }, "Owner: Token #", project.ownerTokenId), /*#__PURE__*/React.createElement("div", {
    className: "project-status",
    style: {
      color: project.status === 2 ? 'var(--success)' : project.status === 3 ? 'var(--error)' : 'var(--sky)'
    }
  }, "Status: ", projectStatuses[project.status]), /*#__PURE__*/React.createElement("p", null, "Created: ", formatDate(project.createdAt)), project.completedAt > 0 && /*#__PURE__*/React.createElement("p", null, "Completed: ", formatDate(project.completedAt)))))), /*#__PURE__*/React.createElement(Modal, {
  ...
  }, "\u26A0\uFE0F You have ", totalProjects, "/", MAX_PROJECTS, " projects. ", totalProjects >= MAX_PROJECTS ? 'Cannot create more!' : 'Approaching limit!')), /*#__PURE__*/React.createElement(Input, {
    label: "Project Title",
    value: projectData.title,
    onChange: val => setProjectData({
      ...projectData,
      title: val
    }),
    ...
    disabled: totalProjects >= MAX_PROJECTS
  }, totalProjects >= MAX_PROJECTS ? 'Limit Reached' : 'Create Project')))), /*#__PURE__*/React.createElement(Modal, {
    ...
    style: {
      background: (selectedProject.collaborators?.length || 0) >= MAX_COLLABORATORS * 0.9 ? 'rgba(245, 158, 11, 0.1)' : 'rgba(6, 182, 212, 0.1)',
      border: `1px solid ${(selectedProject.collaborators?.length || 0) >= MAX_COLLABORATORS * 0.9 ? 'rgba(245, 158, 11, 0.3)' : 'rgba(6, 182, 212, 0.3)'}`,
      borderRadius: '8px',
      padding: '12px',
      marginBottom: '16px'
    }
    ...
    style: {
      fontSize: '0.9rem',
      color: (selectedProject.collaborators?.length || 0) >= MAX_COLLABORATORS * 0.9 ? 'var(--warning)' : 'var(--teal-light)'
    }
  }, "\uD83D\uDC65 Project #", selectedProject.projectId.toString(), " has ", selectedProject.collaborators?.length || 0, "/", MAX_COLLABORATORS, " collaborators", (selectedProject.collaborators?.length || 0) >= MAX_COLLABORATORS && ' - Limit reached!', (selectedProject.collaborators?.length || 0) >= MAX_COLLABORATORS * 0.9 && (selectedProject.collaborators?.length || 0) < MAX_COLLABORATORS && ' - Approaching limit!'))), /*#__PURE__*/React.createElement(Input, {
  ...
  }, (selectedProject?.collaborators?.length || 0) >= MAX_COLLABORATORS ? 'Limit Reached' : 'Add Collaborator')))), /*#__PURE__*/React.createElement("style", null, `
                .section-header {
                    display: flex;
