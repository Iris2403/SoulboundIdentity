...
predefinedSkills = [
    { id: 0,  name: 'Software Development',        category: 0 },
    { id: 1,  name: 'Web Development',              category: 0 },
    { id: 2,  name: 'Data Analysis',                category: 0 },
    { id: 3,  name: 'AI / Machine Learning',        category: 0 },
    { id: 4,  name: 'Cybersecurity',                category: 0 },
    { id: 5,  name: 'Blockchain Development',       category: 0 },
    { id: 6,  name: 'Project Management',           category: 1 },
    { id: 7,  name: 'Business Strategy',            category: 1 },
    { id: 8,  name: 'Marketing & Digital Marketing',category: 1 },
    { id: 9,  name: 'Sales & Negotiation',          category: 1 },
    { id: 10, name: 'Financial Literacy',           category: 1 },
    { id: 11, name: 'UI/UX Design',                 category: 2 },
    { id: 12, name: 'Content Creation',             category: 2 },
    { id: 13, name: 'Video & Media Production',     category: 2 },
    { id: 14, name: 'Communication Skills',         category: 3 },
    { id: 15, name: 'Leadership & Teamwork',        category: 3 }
];
